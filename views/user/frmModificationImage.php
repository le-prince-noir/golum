...
include_once 'views/commun/nav.php';
 ?>
<section id="membre">
    <form action="<?php echo $_SERVER['HTTP_ROOT']; ?>image/modifier/" method="POST" enctype="multipart/form-data">
        <p>
            Formulaire d'envoi de fichier :<br />
            <input type="file" name="monfichier" /><br /> <br />
            <label for="titreImg">Titre de l'image :</label>
            <input type="text" name="titreImg" id="titreImg" value="<?php echo $titreImg; ?>" /><br />
            <label for="descImg">Description de l'image (peut être vide): </label>
            <textarea row="6" col="3" id="descImg" name="descImg"><?php echo "$descImg"; ?></textarea>
            <input type="hidden" name="frmModification" /><br />
